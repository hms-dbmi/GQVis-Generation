...
def add_row(df, query_template, spec, constraints, justification, taxonomy_type: QueryTaxonomy,query_type: QueryType, chart_type: ChartType):
...
if __name__ == "__main__":
    ...
    df.to_csv('multistep_generation2.tsv', sep='\t')
    print(df.head())
