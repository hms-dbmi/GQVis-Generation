...
def main():
    ...
    followups['What is the <E> data?'] = {
        ...
        ('Overlay <E0>.', 'overlay', ''),
        ('Make <E> circular.', 'visual change', 'circular'),
        ('Give <E> a linear layout.', 'visual change', 'linear'),
        ('Add a detail view of <E> at <L>.', 'visual change', 'detail view'),
    ...
    followups['What is the <E> data at <L>?'] = {
        ...
        ('Make <E> circular.', 'visual change', 'circular'),
        ('Give <E> a linear layout.', 'visual change', 'linear'),
        ('Add a whole-genome view of <E>.', 'visual change', 'general view'),
        ('Stratify the <E> data.', 'data stratification', ''),
